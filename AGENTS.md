...
Use beads for tracked work and keep transient planning in the session, not in ad hoc markdown files or dump directories such as `history/`, `working_doc/`, or `working_docs/`.
