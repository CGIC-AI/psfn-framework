...
8. **Channel Layer** — Discord adapter (voice reverse RPC for gateway split), OpenAI-compatible API, admin GUI (admin UI — Svelte 5 SPA at `/garden`; legacy htmx server deprecated, next release removes it)
