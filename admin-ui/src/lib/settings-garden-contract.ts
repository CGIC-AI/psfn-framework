...
export const SETTINGS_GARDEN_FIELD_EXPOSURE = {
  ...
  memoryBudgetPct: { sectionId: 'memory', surface: 'advanced' },
  ...
  discordEnabled: { sectionId: 'channels', surface: 'advanced' },
  discordHeartbeatChannel: { sectionId: 'channels', surface: 'advanced' },
