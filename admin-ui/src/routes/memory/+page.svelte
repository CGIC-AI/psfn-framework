...
{#if detailModalId}
  <MemoryDetailModal
    ...
    {linkTypeById}
    {loadingLinksFor}
    memoryLinkTypes={MEMORY_LINK_TYPES}
    {scopeEditorRefLabel}
    {scopeEditorTags}
    {scopeMutating}
    {supersedeConfirmId}
    ...
    onSupersedeConfirmChange={(id) => { supersedeConfirmId = id; }}
    onLinkTargetChange={(id, value) => { linkTargetById = { ...linkTargetById, [id]: value }; }}
    onLinkTypeChange={(id, value) => { linkTypeById = { ...linkTypeById, [id]: value }; }}
    onLinkMemory={handleLinkMemory}
    onUnlinkMemory={handleUnlinkMemory}
    onScopeEditorRefLabelChange={(value) => { scopeEditorRefLabel = value; }}
    onScopeEditorTagsChange={(value) => { scopeEditorTags = value; }}
  />
{/if}
