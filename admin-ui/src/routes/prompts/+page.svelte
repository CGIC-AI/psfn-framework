<script lang="ts">
  ...
  const MACROS = [
    ...
    { token: '{{user}}', desc: 'Current author/user display name from runtime context.', example: 'Operator' },
    { token: '{{char}}', desc: 'Character/assistant name from runtime context.', example: 'PSFN' },
