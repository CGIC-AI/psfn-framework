      ...
      <div class="flex items-start gap-3">
        ...
        <div>
          <p class="text-sm text-shadow-800">
            The scheduler JSON API endpoint (<code class="font-mono text-sm bg-bark-100 px-1.5 py-0.5 rounded text-gold-700">/api/admin/scheduler</code>) is not yet available.
          </p>
