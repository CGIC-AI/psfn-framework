  ...
  <div class="flex items-center justify-between">
    ...
    <div class="flex items-center gap-3">
      <button onclick={doRefreshModels}
        class="px-3 py-1.5 text-xs font-medium rounded-lg border border-bark-300 dark:border-shadow-600 text-shadow-500 dark:text-shadow-400 hover:bg-bark-100 dark:hover:bg-shadow-700 transition-colors">
        Refresh Models
      </button>
              ...
              <div class="px-5 pb-4 space-y-3 border-t border-bark-100 dark:border-shadow-800 pt-3">
                {#each sectionKeys as key}
                  ...
                  <div class="flex flex-col sm:flex-row sm:items-center gap-2">
                    <label class="text-xs font-mono text-shadow-600 dark:text-shadow-400 sm:w-56 shrink-0">{key}</label>
    ...
    <div class="space-y-4">
      {#each [
        ...
        <div class="card-garden p-4">
          <h3 class="text-xs font-serif font-semibold text-shadow-600 dark:text-shadow-400 mb-2">{editor.label}</h3>
          <textarea
            value={editor.get()}
