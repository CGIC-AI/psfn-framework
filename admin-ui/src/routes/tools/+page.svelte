...
<div class="space-y-6">
  ...
  <div>
    ...
    <p class="text-sm text-shadow-400 dark:text-shadow-500 mt-1">Tools and services available to the substrate agent</p>
  </div>
  ...
  <div class="card-garden p-4">
    <div class="flex items-start gap-3">
      ...
      <div class="text-sm text-shadow-600 dark:text-shadow-400">
  ...
  <div>
    <h2 class="text-lg font-serif font-semibold text-shadow-700 dark:text-bark-300 mb-3">
      Core Tools
      <span class="text-xs font-sans font-normal text-shadow-400 dark:text-shadow-500 ml-2">{CORE_TOOLS.length} tools &mdash; always available</span>
    </h2>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
      {#each CORE_TOOLS as tool}
        <div class="card-garden p-4">
          ...
          <p class="text-xs text-shadow-500 dark:text-shadow-400 leading-relaxed">{tool.description}</p>
        </div>
      {/each}
    </div>
  </div>
  ...
  <div>
    <h2 class="text-lg font-serif font-semibold text-shadow-700 dark:text-bark-300 mb-3">
      Extended Tools
      <span class="text-xs font-sans font-normal text-shadow-400 dark:text-shadow-500 ml-2">{EXTENDED_TOOLS.length} tools &mdash; loaded on demand</span>
    </h2>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
  ...
  <div>
    ...
    <div class="card-garden p-8 text-center">
      ...
      <p class="font-serif text-shadow-500 dark:text-shadow-400">Health checks coming soon</p>
      <p class="text-xs text-shadow-400 dark:text-shadow-500 mt-1">LLM, embeddings, gateway, scheduler, and Discord connectivity status</p>
    </div>
  </div>
</div>
