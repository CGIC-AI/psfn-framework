...
async def test_psfn_streaming_provider_streams_deltas_and_persists_history() -> None:
    ...
    async def handler(request: httpx.Request) -> httpx.Response:
        ...
        request_headers.append({
            ...
            "x-psfn-satellite-addressed-companion-id": request.headers.get(
    ...
    provider = PsfnStreamingProvider(
        ...
        claim_config=normalize_claim_config(
            ...
            addressed_companion_id="11111111-1111-4111-8111-111111111111",
        ),
        client=client,
    ...
    assert request_headers[0] == {
        ...
        "x-psfn-satellite-addressed-companion-id": "11111111-1111-4111-8111-111111111111",
