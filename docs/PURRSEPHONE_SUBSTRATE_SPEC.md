...
### What to preserve
- **Purrsephone's character card** (`/path/to/your/character.json`)
...
- [PURRSEPHONE_MEMORY_ARCHITECTURE_v2.md](/home/user/ai/eliza/PURRSEPHONE_MEMORY_ARCHITECTURE_v2.md) — Existing design doc
- [ElizaOS plugin-purrsephone](/home/user/ai/eliza/packages/plugin-purrsephone/) — Existing L0/L2 implementation
