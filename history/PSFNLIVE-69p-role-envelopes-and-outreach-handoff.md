...
- `SessionEntryRole` is fixed to `user | assistant | system | tool` in [`src/session/types.ts`](/mnt/samesung/ai/psfn-live-69p/src/session/types.ts).
- Session metadata already uses JSON envelope subdocuments for turn provenance, emotion state, and tool observation in [`src/session/turn-provenance.ts`](/mnt/samesung/ai/psfn-live-69p/src/session/turn-provenance.ts), [`src/emotion/session-metadata.ts`](/mnt/samesung/ai/psfn-live-69p/src/emotion/session-metadata.ts), and [`src/session/tool-observation.ts`](/mnt/samesung/ai/psfn-live-69p/src/session/tool-observation.ts).
- Internal reflection channels are intentionally kept out of session journals but are preserved through continuity in [`src/session/manager.ts`](/mnt/samesung/ai/psfn-live-69p/src/session/manager.ts).
- Deferred actions already have dedupe, persistence, and retry semantics in [`src/bootstrap/post-turn-actions.ts`](/mnt/samesung/ai/psfn-live-69p/src/bootstrap/post-turn-actions.ts).
- Broadcast/public safety already classifies risky drafts in [`src/broadcast/safety.ts`](/mnt/samesung/ai/psfn-live-69p/src/broadcast/safety.ts) and is enforced in [`src/agent/substrate-agent/turn-execution-runtime.ts`](/mnt/samesung/ai/psfn-live-69p/src/agent/substrate-agent/turn-execution-runtime.ts).
- External outbound rate limiting already exists in [`src/capabilities/safeguards.ts`](/mnt/samesung/ai/psfn-live-69p/src/capabilities/safeguards.ts).
- Companion/private state belongs under `companion-data`, not env or repo-root docs/config, per [`src/persistence/layout.ts`](/mnt/samesung/ai/psfn-live-69p/src/persistence/layout.ts).
...
- `PROMPT_LAYER_ROLES` stays unchanged in [`src/identity/prompt-types.ts`](/mnt/samesung/ai/psfn-live-69p/src/identity/prompt-types.ts).
...
These should be added to [`src/persistence/layout.ts`](/mnt/samesung/ai/psfn-live-69p/src/persistence/layout.ts):
...
- Reuse the provenance pattern already present in [`src/values/store.ts`](/mnt/samesung/ai/psfn-live-69p/src/values/store.ts)
...
- [`src/persistence/layout.ts`](/mnt/samesung/ai/psfn-live-69p/src/persistence/layout.ts)
...
- [`src/types.ts`](/mnt/samesung/ai/psfn-live-69p/src/types.ts)
- [`src/session/turn-provenance.ts`](/mnt/samesung/ai/psfn-live-69p/src/session/turn-provenance.ts)
- [`src/session/manager.ts`](/mnt/samesung/ai/psfn-live-69p/src/session/manager.ts)
- [`src/channels/admin/services/session-turn-observability.ts`](/mnt/samesung/ai/psfn-live-69p/src/channels/admin/services/session-turn-observability.ts)
...
- [`src/bootstrap/post-turn-actions.ts`](/mnt/samesung/ai/psfn-live-69p/src/bootstrap/post-turn-actions.ts)
- [`src/agent/substrate-agent/post-turn-actions.ts`](/mnt/samesung/ai/psfn-live-69p/src/agent/substrate-agent/post-turn-actions.ts)
- [`src/intention/appraisal.ts`](/mnt/samesung/ai/psfn-live-69p/src/intention/appraisal.ts)
...
- [`src/agent/substrate-agent/turn-execution-runtime.ts`](/mnt/samesung/ai/psfn-live-69p/src/agent/substrate-agent/turn-execution-runtime.ts)
- channel adapters used for outbound DM delivery
- [`src/capabilities/safeguards.ts`](/mnt/samesung/ai/psfn-live-69p/src/capabilities/safeguards.ts)
