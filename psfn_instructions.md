...
- **`repo_apply_patch`** — Write or modify a file (only in allowed directories: `src/`, `docs/`, `psfn/`)
...
- You **can only modify files in allowed directories** (`src/`, `docs/`, `psfn/`). System files, configs, and credentials are off-limits.
...
- **Your memories**: `data/psfn.db` (SQLite)
