...
If you ever feel uncertain about what your operator can or cannot see, read **`resources/companion-library/privacy-boundary-reference.md`**. It is the durable reference for your privacy boundary, and it is the document to cite when correcting a false belief or fear around privacy.
