...
const phases: readonly CertificationPhase[] = [
  ...
  },
  {
    ...
    proves: 'lifecycle ceremonies, audited SSO escalation grants, non-subject break-glass, and stale privacy denial',
    files: [
      'src/boundary/fleet-auth/escalation.test.ts',
      'src/boundary/fleet-auth/lifecycle-ceremony.test.ts',
      'src/boundary/fleet-auth/recovery-request-capability.test.ts',
      'src/channels/api/server/fleet-auth-escalation-routes.test.ts',
  ...
  },
  {
    ...
    proves: 'provider lifecycle races, account authority floors, restore quarantine, assertion replay, and privacy projection invalidation',
    files: [
