...
const TEXT_REFERENCE_ALLOWLIST = [
  ...
  },
  {
    ...
    contains: 'SQLite implementations and migration readers are',
    classification: 'cutover-contract',
    reason: 'Architecture documents the absence of the old adapter family.',
  },
  {
    path: 'docs/architecture.md',
    contains: 'there is no SQLite runtime path.',
    classification: 'cutover-contract',
    reason: 'Architecture makes the port boundary unambiguous.',
  },
  {
    path: 'docs/development-status.md',
    contains: 'SQLite-centered prototype shape: SQLite implementations and packages are removed',
  ...
  },
  {
    ...
    contains: 'There is no SQLite runtime path and no',
  ...
  {
    path: 'docs/specifications.md',
    contains: 'never open them through a SQLite implementation',
    classification: 'legacy-artifact-contract',
  ...
  },
  {
    ...
    contains: 'there is no SQLite runtime',
    classification: 'cutover-contract',
    reason: 'Operations states Postgres is the only persistence backend.',
  },
  {
    path: 'docs/operations.md',
    contains: 'SQLite backup verification is retired',
    classification: 'fail-closed-regression',
    reason: 'Operations records that SQLite backup verification is retired.',
  },
  {
    path: 'docs/specifications.md',
    contains: 'silent fallbacks, or SQLite runtime paths',
    classification: 'cutover-contract',
    reason: 'The spec forbids SQLite runtime paths when prose and code disagree.',
  },
  {
    path: 'docs/specifications.md',
    contains: 'SQLite packages in `package.json`',
    classification: 'cutover-contract',
    reason: 'The spec forbids retired SQLite packages in the lockfile.',
  },
  {
    path: 'docs/specifications.md',
    contains: 'shell-sandbox `sqlite3`',
    classification: 'legacy-artifact-contract',
    reason: 'The spec names the sanctioned network-less sqlite3 residual.',
  },
  {
    path: 'docs/specifications.md',
    contains: 'SQLite recovery-index worker',
    classification: 'legacy-artifact-contract',
    reason: 'The spec names the temporary recovery-index residual.',
  },
  {
    path: 'docs/specifications.md',
    contains: 'No SQLite runtime path; no persistence backend fallbacks that change truth',
    classification: 'cutover-contract',
    reason: 'The spec restates the no-SQLite runtime law.',
  },
  {
    path: 'docs/specifications.md',
    contains: 'mechanical Postgres-only persistence gate — retired SQLite packages, retired',
    classification: 'cutover-contract',
    reason: 'The spec points at the mechanical Postgres-only gate.',
  },
  {
