...
- `harness/` — (build-out in progress under epic `psfn-framework-65rk`) the scripted Layer A harness: shared probe library, tier sweep, tool-conformance and Garden sweeps, scorecard.
