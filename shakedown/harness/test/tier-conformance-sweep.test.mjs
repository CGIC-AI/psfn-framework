...
async function main() {
  ...
  check(
    resolved.adminReadinessUrl
      === `http://127.0.0.1:10053/companions/${companionId}/garden/api/admin/tools/adaptive`,
    'kube Garden readiness uses the sanctioned unified-origin verifier route',
  );
  check(
