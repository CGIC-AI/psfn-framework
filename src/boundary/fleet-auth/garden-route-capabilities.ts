...
const queryPolicies: Readonly<Partial<Record<string, Readonly<Partial<Record<string, GardenQueryFieldPolicy>>>>>> =
  Object.freeze({
    ...
    '/api/admin/cogsec/blind-review': singleton([]),
    ...
    '/api/admin/fleet-model-usage': singleton([
      'range', 'timezone', 'sinceMs', 'untilMs', 'bucket',
    ]),
...
const requiredBodyPatterns = new Set([
  ...
  'POST /v1/fleet-auth/lifecycle/account/complete',
  'POST /login',
  ...
  'POST /api/admin/icp-autonomy/lifecycle/readmit',
...
const noBodyMutationPatterns = new Set([
  ...
  'POST /api/admin/channels/bearer-companion',
...
const fixedRoutes: readonly RouteTuple[] = [
  ...
  ['GET', '/api/admin/automata'], ['POST', '/api/admin/automata/reindex'],
  ...
  ['POST', '/api/admin/image-references/rollback-default'],
  ...
  ['GET', '/api/admin/model-usage/export'], ['GET', '/api/admin/fleet-model-usage'],
  ...
  ['POST', '/api/admin/tools/mcp/release'],
  ['GET', '/api/admin/values'], ['GET', '/api/admin/values/status'],
  ['GET', '/api/admin/values/reflections/daily'],
...
const dynamicRoutes: readonly RouteTuple[] = [
  ...
  ['POST', '/api/admin/concerns/:concernId/transition'],
  ['GET', '/api/admin/concerns/:concernId/arcs'],
