...
const DM_CHANNEL_ID = 'companion-dm:11111111-1111-4111-8111-111111111111:22222222-2222-4222-8222-222222222222';
...
async function setupLoopHarness(): Promise<{
  ...
  const lane = new GatewayCompanionChannelLane({
    ...
    presence: {
      listByPlace: async () => [
        { companionId: '11111111-1111-4111-8111-111111111111', updatedAt: FRESH, since: FRESH },
        { companionId: '22222222-2222-4222-8222-222222222222', updatedAt: FRESH, since: FRESH },
      ],
    },
    fleetCompanionIds: new Set(['11111111-1111-4111-8111-111111111111', '22222222-2222-4222-8222-222222222222']),
    now: () => NOW,
  });
  ...
  const nova = new LaneAgent('11111111-1111-4111-8111-111111111111', 'Nova', config);
  const selene = new LaneAgent('22222222-2222-4222-8222-222222222222', 'Selene', config);
...
describe('two-companion loop through the real gateway lane (W6 acceptance)', () => {
  it('bounds a no-human room exchange: charges companion_room budgets, walks to hard exhaustion, terminates', async () => {
    ...
    expect(selene.received.every(message => message.authorId === '11111111-1111-4111-8111-111111111111')).toBe(true);
    expect(nova.received.every(message => message.authorId === '22222222-2222-4222-8222-222222222222')).toBe(true);
