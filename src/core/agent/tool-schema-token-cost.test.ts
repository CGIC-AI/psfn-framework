...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 80_301,
      afterBytes: 95_675,
      providerSchemaHash: '8bc3fe1327fdda1a6e71b46a619bf37246323b67a97ab05b96acf6f85b5cb62e',
      parameterSchemaHash: '1fa0759f22bb728ef027388fc533d49fc240b036970bb9ee68ed94313bae42ba',
    });
