...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 93_988,
      afterBytes: 113_044,
      providerSchemaHash: '5ad2f6af6549adf0955e0d0d164b53d744c4dde7673ef74d5cd5421ec7d06045',
      parameterSchemaHash: '5dc3b3e541eafaefd29a7c512ae8995388f257e355250eee18c8c3dae34416a5',
    });
