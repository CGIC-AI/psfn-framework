...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 89_221,
      afterBytes: 107_198,
      providerSchemaHash: '49666bf3ec5ec2db54ea3c55074d3f22e9cc9f614c6c3b23c745d68ca5856c61',
      parameterSchemaHash: '3a55efe1b3e2c7f61e9e333c3849ba04588beb5ef665337e67bc1a0a26dfcd8c',
    });
