...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 79_098,
      afterBytes: 93_421,
      providerSchemaHash: 'ed1093344bd3afb241af33a36904aa94f577c9896e3e4e7e7a117e90fb5ca941',
      parameterSchemaHash: 'd9db38b21a215732989546724d04c2a46cc53fdfa879b4135c109f7b3cfdb4c7',
    });
