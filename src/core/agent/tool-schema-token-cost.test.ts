...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 82_428,
      afterBytes: 98_647,
      providerSchemaHash: 'a3daca715e3e743719b86253e4f688ed95bb242f1133bf10c1f5c84a6a1ba8eb',
      parameterSchemaHash: 'b7f88e79c4ce2f647f8985aaf4a832bd159253e9256ea57c52f751f9033f1296',
    });
