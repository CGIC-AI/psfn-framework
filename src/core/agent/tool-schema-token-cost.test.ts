...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 77_994,
      afterBytes: 90_233,
      providerSchemaHash: 'f764c228cf1f18eacad69d688f69fcd0b475b59a1ef615cda25cfb991aa2614c',
      parameterSchemaHash: '44f663b27e22bfddd386fde11890c4374b4fb5dc3bcaa9f200736f3f5e6dfaad',
    });
