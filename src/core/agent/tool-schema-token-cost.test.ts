...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 79_731,
      afterBytes: 94_761,
      providerSchemaHash: '3394b6d6622f0628a9da42f37fa014ab7f80d3fa44de04b9d788ee6a7af6f827',
      parameterSchemaHash: '8326c3aa019df57a70fc8420630fa01e74f9e3aae64041617b1658d970ee0de9',
    });
