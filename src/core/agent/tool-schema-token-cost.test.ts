...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 80_814,
      afterBytes: 96_467,
      providerSchemaHash: '77f802fb5a02db269427a86d85858a5f7e72706ca1af790d6099407e709c11c6',
      parameterSchemaHash: 'c420544af5a2d5e2aece1201cc7f01a0d4c37829b43266a071a8e7a1caf38cd7',
    });
