...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 78_677,
      afterBytes: 91_514,
      providerSchemaHash: '51419fbc5c99fe3a5ab3a29f313852dcedd1990b4f3ec8e557d8370b8a936d76',
      parameterSchemaHash: '98579323860ce54bd3bae9658efc22ad036f84133f2ad8a3b2d09a5431d0b6e2',
    });
