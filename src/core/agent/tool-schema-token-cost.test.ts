...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 78_208,
      afterBytes: 90_494,
      providerSchemaHash: '4f2a469c313ccb8eb8a291e57c513be92c714469aa047c608488cdfe46eea1f6',
      parameterSchemaHash: '95bc1c57412f2548d76e02a7b2e0574fd3b4518ca2afd22ee344f174a6437b09',
    });
