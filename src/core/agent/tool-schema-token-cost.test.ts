...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 80_169,
      afterBytes: 95_403,
      providerSchemaHash: 'fed072da01a0cc5e7b6dbf1897a9de0eb88fd2be369c1a024a8deca95cbbc9ca',
      parameterSchemaHash: '4886e3a015379c077929d4c635551948612499363922fa297cca380d583af012',
    });
