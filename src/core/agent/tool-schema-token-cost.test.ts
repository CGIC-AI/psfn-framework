...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 78_914,
      afterBytes: 91_751,
      providerSchemaHash: '8e7a2b788b66bc208eb036f902e2cad219b99c8ddcb3c90d03adc53b93af0d3d',
      parameterSchemaHash: 'fef4e8dbe6812008f0d2fc3c1ab032ed101db7dff24ada3a5ac8fbfdab081764',
    });
