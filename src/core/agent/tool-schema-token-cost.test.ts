...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 89_069,
      afterBytes: 107_046,
      providerSchemaHash: '49a77f3a897d0a92907d7641e117faed7fede352231fd6db94b7b29fe876117e',
      parameterSchemaHash: 'cea808d8ddd650f9e801a21b1908ebb33b6b71a2e6acedb47ad1d77149bf58b9',
    });
