...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 90_726,
      afterBytes: 108_703,
      providerSchemaHash: '7e6236f697d0ca99c55a046e6bb758af20f069190f411367341e6ab6bd6dfe88',
      parameterSchemaHash: 'd7a41cf0980e5f46302be767f551e3d7eb31b4214f6c1fc72c643d7be55f7e64',
    });
