...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 86_107,
      afterBytes: 102_814,
      providerSchemaHash: '6b7836882babbd98bf64ef97fc565c197ecc0557df710e2a98efd63214d0319a',
      parameterSchemaHash: '6932116ecf7182512a263f197de821b1e040e594f4e9b9658d13f705e28792a1',
    });
