...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 80_830,
      afterBytes: 96_483,
      providerSchemaHash: '2eadcd25709273729563359ba0de925f80938928fe50f48286af3fc69abcbc82',
      parameterSchemaHash: '6cf0b72124823227195809e2fce9f17ce8957acb01ef77427a5373286639a12a',
    });
