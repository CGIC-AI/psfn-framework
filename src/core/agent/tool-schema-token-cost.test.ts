...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 82_235,
      afterBytes: 98_454,
      providerSchemaHash: 'a25507233422d71e9db77fc69a4bb9c097e0628ccae321c1ceb176a26d935b30',
      parameterSchemaHash: 'eeee8710b69ebd09e1c70179b327e12868c4345448e8fef1c4520e23b799a27a',
    });
