...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 80_549,
      afterBytes: 95_923,
      providerSchemaHash: '88378a3e3b908142627796dfdde2f49851b016c54ced74bbb0e05ce9c842fb58',
      parameterSchemaHash: 'd4308dbb408e4dbf262bff1b150f46e6fa461d07ac541a8ff78d6c262d1e257a',
    });
