...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 82_443,
      afterBytes: 98_969,
      providerSchemaHash: '5e9275b7c50642240cf4158781382be583f8d8248752a01a11663bc174953b3e',
      parameterSchemaHash: '56ace23194b1b062b4f58d6039f057224ab31c08d00dd88281a58f628e82fa50',
    });
