...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 89_009,
      afterBytes: 106_986,
      providerSchemaHash: 'ede098472f081d84dfb64d372cf5f62a0eee3c891228a53a8e60dd4b0ae0b086',
      parameterSchemaHash: '7b841ba42135124f69535afc90d7ef0f1c3872cf4c9e3ead701006819f55b32a',
    });
