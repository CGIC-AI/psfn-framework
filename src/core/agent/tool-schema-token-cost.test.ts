...
describe('full callable catalog schema token cost', () => {
  it('measures the fixed pre/post-description provider payload with the real schemas', () => {
    ...
    expect({
      ...
      beforeBytes: 79_333,
      afterBytes: 94_146,
      providerSchemaHash: '09ea6d5b24e49a7203ef92aabbf38f841f27f2801567816230664d99e87f0017',
      parameterSchemaHash: 'fe8a2db47453b29821a062f13574db94d753bdef49f52c64e2544ae62da435b6',
    });
