...
export const OPERATIONS_TOOL_CONTRACTS = {
  ...
  wiki: {
    ...
    output: 'It returns documents, matches, project/wardrobe manifests, or queues a public shared-world proposal for operator review; semantic search fails closed when unwired.',
    guidance: 'Do not use wiki for lived memory or journal reflection; use memory or journal. Projects and named looks remain in the personal wiki tier. Shared-world proposals and project share intent never publish directly.',
