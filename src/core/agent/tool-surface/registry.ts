...
export const CANONICAL_FIRST_PARTY_TOOL_SURFACES: readonly CanonicalToolSurfaceEntry[] = [
  ...
  },
  {
    ...
    retiredAliases: [
      retiredAlias('load_tools', 'toolset', 'hidden', 'list', 'All registered tools are callable without a loading step.'),
  ...
  },
  {
    ...
    actions: ['write', 'search', 'shared_background', 'census', 'exists', 'timeline', 'import', 'patch', 'redact', 'delete', 'restore'],
    capabilityMetadata: { kind: 'action_aware', source: CAPABILITIES_REQUIREMENTS },
    retiredAliases: [
  ...
  },
  {
    ...
    actions: ['list', 'read', 'search', 'semantic_search', 'write', 'import'],
    capabilityMetadata: { kind: 'action_aware', source: CAPABILITIES_REQUIREMENTS },
    retiredAliases: [],
  },
  {
  ...
  },
  {
    ...
    capabilityMetadata: { kind: 'action_aware', source: CAPABILITIES_REQUIREMENTS },
    retiredAliases: [
      retiredAlias('schedule_task', 'schedule', 'hidden', 'schedule_prompt', 'Scheduled work belongs on schedule.'),
      retiredAlias('heartbeat_update_policy', 'schedule', 'hidden', 'update_template', 'Heartbeat policy changes belong on schedule.'),
    ],
  },
  {
    name: 'north_star',
