...
export const RUNTIME_STATE_PROMPT_RUNTIME_MACRO_HINTS: PromptRuntimeMacroHint[] = [
  ...
  runtimeStateTurnHint('{{runtime_current_message_author_xml}}', 'Preformatted current message author XML with optional per-participant timezone/local_time attributes when known.', '<current_message_author name="Vega" id="discord:123456789" timezone="America/Chicago" local_time="9:42 PM" />'),
