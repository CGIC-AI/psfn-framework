...
export const GLOBAL_PROMPT_RUNTIME_MACRO_HINTS: PromptRuntimeMacroHint[] = [
  ...
  createPromptRuntimeMacroHint('global_aliases', '{{user}}', 'session_stable', SESSION_BASE_PRODUCER, 'Current Participant display name from runtime context.', 'PrimaryUser', ['user_name']),
...
export const RUNTIME_STATE_PROMPT_RUNTIME_MACRO_HINTS: PromptRuntimeMacroHint[] = [
  ...
  createPromptRuntimeMacroHint('runtime_state', '{{runtime_context_extra}}', 'session_stable', RUNTIME_LAYOUT_OVERLAY_PRODUCER, 'Companion-authored runtime context overlay text from the prompt runtime layout.', 'The Partner is travelling this week.'),
  ...
  runtimeStateTurnHint('{{runtime_current_message_author_xml}}', 'Preformatted current message author XML. Group turns may include timezone/local_time and content-free last_direct_interaction_* attributes from another private chat when known; private content and channel identity are never included.', '<current_message_author name="Morgan" id="discord:123456789" timezone="America/Chicago" local_time="9:42 PM" last_direct_interaction_at="2026-03-27T21:42:00.000-04:00" last_direct_interaction_ago="1 hour ago" last_direct_interaction_context="another_chat" />'),
  runtimeStateTurnHint('{{runtime_current_message_author_name}}', 'Display name of the author of the current message.', 'Morgan'),
  ...
  runtimeStateTurnHint('{{runtime_current_message_author_name_xml_attr}}', 'XML-attribute-safe display name of the current message author.', 'Morgan'),
  ...
  runtimeStateTurnHint('{{runtime_recent_active_participants_xml}}', 'Compact recent active participant XML for group turns, capped at five deduped authors. Known human participants may carry content-free last_direct_interaction_* attributes from another private chat; private content and channel identity are never included.', '<recent_active_participants max="5">...</recent_active_participants>'),
  ...
  runtimeStateTurnHint('{{runtime_speaking_with_name}}', 'Resolved speaking-partner display name on DM turns; blank on group and internal turns so speaking_with sections prune.', 'Morgan'),
  ...
  runtimeStateTurnHint('{{runtime_channel_type}}', 'Resolved channel type for the current speaking context when Participant-facing.', 'discord_text'),
  runtimeStateTurnHint('{{runtime_channel_visibility}}', 'Resolved channelPrivacy for the current speaking context when Participant-facing (broadcast is {{runtime_broadcast}}).', 'private'),
...
export const TRUST_PROMPT_RUNTIME_MACRO_HINTS: PromptRuntimeMacroHint[] = [
  trustTurnHint('{{runtime_trust_is_primary}}', 'Whether the current author has primary trust.', 'false'),
...
export const TOOLING_PROMPT_RUNTIME_MACRO_HINTS: PromptRuntimeMacroHint[] = [
  ...
  toolingTurnHint('{{runtime_tooling_extended_count}}', 'Count of active extended tools.', '2'),
  toolingTurnHint('{{runtime_tooling_registered_extended_count}}', 'Count of extended tools registered for the turn before policy filters.', '3'),
  ...
  toolingTurnHint('{{runtime_extended_tools_callable_count}}', 'Count of extended tools callable under the current capability tier.', '2'),
  ...
  toolingTurnHint('{{runtime_extended_tool_directory_lines}}', 'Extended tool directory lines without any extra prose preface.', '- web: Fetch a web page (call directly; no activation step)'),
