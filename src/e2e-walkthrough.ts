...
async function main(): Promise<void> {
  ...
  await talk(agentLoop,
    "Thank you, Purrsephone. You've been wonderful through all of this. the primary user will review this conversation. Is there anything you'd like to say before we wrap up?",
  );
