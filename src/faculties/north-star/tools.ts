  ...
  const tool: SubstrateAgentTool = {
    ...
    execute: async (
      ...
      try {
        switch (action) {
          case 'list':
            return executeNorthStarListAction(store);
          case 'create':
            return executeNorthStarCreateAction(store, params as {
              title: string;
              content: string;
              scope?: NorthStarScope;
              enabled?: boolean;
          ...
          case 'update':
            return executeNorthStarUpdateAction(store, params as {
              item_id: string;
              title?: string;
              content?: string;
              scope?: NorthStarScope;
          ...
          case 'delete':
            return executeNorthStarDeleteAction(store, params as { item_id: string });
          case 'reorder':
            return executeNorthStarReorderAction(store, params as { item_ids: string[] });
        }
...
async function executeNorthStarListAction(
...
async function executeNorthStarCreateAction(
  store: NorthStarStore,
...
async function executeNorthStarUpdateAction(
  store: NorthStarStore,
...
async function executeNorthStarDeleteAction(
  store: NorthStarStore,
...
async function executeNorthStarReorderAction(
  store: NorthStarStore,
