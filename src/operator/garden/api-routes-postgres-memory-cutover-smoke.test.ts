...
function makeServices(): GardenAdminDomainServices {
  ...
  return {
    ...
    images: {
      ...
      promoteGeneratedImageToReference: async () => { throw new Error('not used in smoke'); },
      ...
      rollbackDefaultReferencePhoto: async () => { throw new Error('not used in smoke'); },
      getReferenceLineage: async () => { throw new Error('not used in smoke'); },
