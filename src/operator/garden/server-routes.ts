...
export function buildAdminRoutes(deps: AdminRouteDependencies): AdminRoute[] {
  ...
  const routes = compileGardenRouteDeclarations([
    ...
    ...buildAdminApiRoutes({
      ...
      satelliteDeviceHealth: deps.services.satelliteDeviceHealth,
      ...
      incidentTimelineService: deps.services.incidents ?? null,
      humanEscalationService: deps.services.humanEscalations ?? null,
