...
import {
  FLEET_AUTH_REGISTER_ROSTERED_FIRST_OWNER_COMPANIONS_DDL_SQL,
  FLEET_AUTH_REGISTER_ROSTERED_FIRST_OWNER_COMPANIONS_FUNCTION_ARG_TYPES,
  FLEET_AUTH_REGISTER_ROSTERED_FIRST_OWNER_COMPANIONS_FUNCTION_NAME,
} from './rostered-first-owner-companion-sql.js';
import {
...
async function applyRoleGrants(
  ...
  await client.query(
    `GRANT EXECUTE ON FUNCTION ${FLEET_AUTH_REGISTER_ROSTERED_FIRST_OWNER_COMPANIONS_FUNCTION_NAME}(${FLEET_AUTH_REGISTER_ROSTERED_FIRST_OWNER_COMPANIONS_FUNCTION_ARG_TYPES}) TO ${runtime}`,
  );
  await client.query(
