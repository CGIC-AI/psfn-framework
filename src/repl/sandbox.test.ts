...
describe('REPLSandbox', () => {
  ...
  it('web browse and search actions use the gateway webFetch path', async () => {
    const llm = {
      ...mockSequentialLLM([
  ...
  it('read_file/write_file/list_files/web fetch helper call gateway RPC capabilities', async () => {
    const llm = {
      ...mockLLM(),
