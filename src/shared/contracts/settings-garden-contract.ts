...
export const SETTINGS_GARDEN_FIELD_EXPOSURE = {
  ...
  cogSecPersonaConformance: { sectionId: 'sessions', surface: 'advanced' },
  ...
  biographicalCandidatePolicy: MEMORY_ADVANCED_EXPOSURE,
  ...
  analysisWorkbenchMaxIterations: { sectionId: 'analysis-workbench', surface: 'advanced' },
  ...
  emosimProactivity: { sectionId: 'analysis-workbench', surface: 'advanced' },
  ...
  ledgerReadChunkBytes: { sectionId: 'sessions', surface: 'advanced' },
  ledgerReadMaxRowBytes: { sectionId: 'sessions', surface: 'advanced' },
  ledgerReadYieldRows: { sectionId: 'sessions', surface: 'advanced' },
  sessionTombstoneAuthorityOwners: { sectionId: 'sessions', surface: 'advanced' },
