...
export function createVaultTool(ops: VaultOperations): AgentTool<any> {
  return {
    ...
    description:
      ...
      + 'Use action=read|write|search|daily. Vault stores durable notes and artifacts; '
      + 'it is distinct from scratchpad’s temporary working context and memory’s structured recall.',
    parameters: Type.Object({
      action: Type.Optional(Type.Union([
        ...
        description: 'Vault action. Preferred actions: read, write, search, daily. Legacy action aliases remain accepted.',
      })),
