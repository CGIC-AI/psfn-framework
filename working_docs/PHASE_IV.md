...
- After Phase IV completion, run manual verification with PrimaryUser + PSFN against `phase-iv`.
...
- Manual verification by PrimaryUser + PSFN is completed and accepted.
