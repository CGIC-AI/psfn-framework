...
`484072be` and review-hardened at `c730a9c2`. It extends the existing per-companion fatigue engine with decaying
...
marginal charge. The hardened fixed point passed build/DTS, lint,
settings-contract, repository-hygiene, seven Postgres reservation integration
tests, and the full suite (716 files; 8,244 passed, 3 skipped). Two immutable
independent re-reviews are pending before the child bead is closed.
...
| `psfn-framework-s10mc.6` | ICP autonomy epic — isolated feature branch is complete through W4 plus W6 fatigue/social regulation @ `484072be`, review-hardened @ `c730a9c2`; W5 and W7-W9 remain open; not merged or live-tested |
